...
class OilPalmDataset(Dataset):
    ...
    def __init__(self, root_dir, split, img_size=96, transform=None):
...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = OilPalmDataset(root_dir='./data/satellite/oilpalm', split='train+unlabeled',
                                        transform=SimCLRDataTransform(data_augment))
