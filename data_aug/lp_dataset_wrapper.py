...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = LPDataset(root_dir='./data/licenseplate', split='train+unlabeled',
                                  transform=SimCLRDataTransform(data_augment))
    ...
    def _get_simclr_pipeline_transform(self):
        ...
        data_transforms = transforms.Compose([transforms.RandomResizedCrop(size=(80,240)),
